...
- apply this approach to "real" data (sea level) and use a "real" physical model [@Rahmstorf2007-sh]
...
First, we will read in the data, and define the model, as in the previous chapters on model calibration. As we have before, we will use the @Church2011-bj data set for global mean sea levels, and the National Oceanic and Atmospheric Administration (NOAA) historical temperature data set.
```{r eval=FALSE}
