...
# Chapter #6: Coin flipping and the bootstrap (Patrick J. Applegate and Klaus Keller)
...
In this chapter, we'll examine the application of the bootstrap to coin flipping.  Coin flips provide a simple, easily-simulated system for thinking about probability; we will generalize the lessons from coin flips to sea level data in the next exercise.  
...
*Part 1.*  Using the second code block above and what you learned about `for` loops in Chapter #2, write an R script that
