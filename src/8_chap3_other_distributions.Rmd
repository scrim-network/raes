...
# Chapter #3: Other probability distributions and random sampling (Patrick J. Applegate)
...
* [triangular distribution](https://en.wikipedia.org/wiki/Triangular_distribution) (you'll need the `triangle` package to work with this distribution; check Chapter #2 for a reminder about how to install and load packages)
