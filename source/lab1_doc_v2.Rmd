...
![Atmospheric carbon dioxide concentrations (top panel), surface air temperature change (middle panel), and sea level change (bottom panel), between 1900 and ~2015.  All three quantities rise over this period, suggesting a causal relationship between them. See text for discussion.](figures/lab1_plot1.pdf)
...
![Contents of `data/lab1_sample_plot1.pdf` after running `lab1_sample.R`.  See text for discussion.](figures/lab1_sample_plot1.pdf)
