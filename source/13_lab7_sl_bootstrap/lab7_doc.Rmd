---
title: 'Exercise #7: Performing a simple bootstrap with the sea level data'
...
In fact, all three of these assumptions are violated by the sea level data.  In particular, this analysis mostly ignores sea level contributions from the ice sheets, and neglects autocorrelation and heteroscedasticity in the residuals.  However, this simplified analysis is an important stepping stone to methods that do account for ice sheets and provide better estimates of the actual uncertainty.  
