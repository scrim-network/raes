---
title: 'Exercise #2: Normal distributions and the Galton board'
...
A [Galton board](http://mathworld.wolfram.com/GaltonBoard.html) is a physical device that demonstrates this concept (Fig. 1).  A Galton board has rows of pins arranged in a triangular shape, with each row of pins offset horizontally relative to the rows above and below it.  The top row has one pin, the second row has two pins, and so forth.  
